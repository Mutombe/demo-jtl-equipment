...
/* ================================================================
   ...
   ================================================================ */
const ICON_MAP = {
  Wrench, HardHat, RoadHorizon, ChartLineUp, Buildings,
};


/* ================================================================
   1. HERO — Industrial Cinematic with Diagonal Overlay
   ================================================================ */
function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      {/* Yellow accent line */}
      <div className="absolute top-[20%] left-0 w-20 sm:w-32 h-[3px] bg-gold-500 z-20" />
      ...
      >
        ...
        >
          <Link
            to="/contact"
            className="group relative inline-flex items-center gap-3 bg-gold-500 text-navy-950 px-7 py-3.5 sm:py-4 font-heading text-sm sm:text-base uppercase tracking-wider font-bold transition-all duration-300 hover:bg-gold-400 hover:shadow-xl hover:shadow-gold-500/20"
          >
            {hero.ctaPrimary}
...
/* ================================================================
   2. MARQUEE — Machine Categories
   ================================================================ */
function MarqueeTicker() {
  const items = ['EXCAVATORS', 'DOZERS', 'LOADERS', 'GRADERS', 'CRANES', 'COMPACTORS', 'DUMP TRUCKS', 'PAVERS', 'BREAKERS'];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              THE POWER<br />
              BEHIND<br />
              <span className="text-gold-500">THE BUILD.</span>
            </h2>
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg">
              Founded in 2010, JTL Equipment was born from a simple observation: Zimbabwe's contractors deserved
              better access to reliable, well-maintained heavy machinery. Too many projects stalled because the
              right equipment was not available when it was needed.
            </p>
            <p className="text-white/40 text-sm leading-relaxed max-w-lg">
              Today we operate from three depots across the country, with a fleet exceeding 200 units and a parts
              warehouse stocking over 15,000 line items. From a single excavator hire to a full mining fleet
              deployment, JTL is the name contractors trust.
            </p>
            ...
            <div className="flex gap-8 sm:gap-12">
              <div>
                ...
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">Machines</div>
              </div>
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl font-bold">3</div>
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">Depots</div>
              </div>
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl font-bold">15K</div>
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">Parts Stocked</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1580901368919-7738efb0f228?w=800"
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  ...
                  alt="Construction machinery fleet"
                  className="w-full aspect-square object-cover object-center"
                  loading="lazy"
                />
              </div>
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-gold-500 text-navy-950 p-4 sm:p-6 shadow-2xl">
                <div className="text-center">
                  <div className="font-heading text-2xl sm:text-3xl font-bold leading-none">14+</div>
                  <div className="text-[10px] sm:text-xs uppercase tracking-wider font-semibold mt-1 text-navy-950/70">
...
/* ================================================================
   5. FLEET SHOWCASE — Horizontal Gallery
   ================================================================ */
function FleetShowcase() {
  ...
  const fleetImages = [
    { src: 'https://images.unsplash.com/photo-1580901368919-7738efb0f228?w=600', caption: 'CAT 320 Excavator' },
    { src: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600', caption: 'Komatsu D65 Dozer' },
    { src: 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=600', caption: 'Volvo L120 Loader' },
    { src: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=600', caption: 'CAT 14M Grader' },
    { src: 'https://images.unsplash.com/photo-1429497419816-9ca5cfb4571a?w=600', caption: 'Liebherr LTM Crane' },
    { src: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=600', caption: 'Bomag BW213 Roller' },
    { src: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600', caption: 'Bell ADT B40' },
    { src: 'https://images.unsplash.com/photo-1580901368919-7738efb0f228?w=600', caption: 'Hitachi ZX350 Breaker' },
  ];
...
function StatsBand() {
  ...
  const stats = [
    { number: '500', suffix: '+', label: 'Deployed' },
    { number: '200', suffix: '+', label: 'Fleet Units' },
    { number: '80', suffix: '+', label: 'Technicians' },
    { number: '3', suffix: '', label: 'Depots' },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <img
              ...
              loading="lazy"
            />
            <div className="absolute -bottom-6 -right-6 bg-gold-500 text-navy-950 p-6 shadow-2xl hidden sm:block">
              <div className="text-3xl font-heading font-bold">{whyChooseUs.experienceYears}</div>
              <div className="text-sm font-semibold text-navy-950/70">{whyChooseUs.experienceLabel}</div>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              {whyChooseUs.titleParts.map((part, i) =>
                part.highlight ? (
                  <span key={i} className="text-gold-500">{part.text}</span>
                ) : (
            ...
            <div className="flex gap-2">
              {homeTestimonials.map((_, i) => (
                <button
                  key={i}
                  onClick={() => setActive(i)}
                  className={`h-[3px] transition-all duration-300 ${i === active ? 'w-8 bg-gold-500' : 'w-3 bg-white/15 hover:bg-white/30'}`}
    ...
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-44 overflow-hidden">
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        ...
        >
          ...
          >
            NEED THE RIGHT<br />
            <span className="text-gold-500">MACHINE?</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact"
              className="group relative inline-flex items-center gap-3 bg-gold-500 text-navy-950 px-8 py-4 font-heading text-sm sm:text-base uppercase tracking-wider font-bold transition-all duration-300 hover:bg-gold-400 hover:shadow-xl hover:shadow-gold-500/20"
            >
              <Phone size={18} />
              {homeCta.ctaPrimary}
              <ArrowRight size={18} className="transition-transform group-hover:translate-x-1" />
